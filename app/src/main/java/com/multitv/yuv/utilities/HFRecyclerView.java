...
public abstract class HFRecyclerView<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<T> data;
    private List<T> fotter_list;

    private boolean mWithHeader;
    private boolean mWithFooter;

    public HFRecyclerView(List<T> data, boolean withHeader, boolean withFooter, List<T> fotter_list) {
        this.data = data;
        this.fotter_list = fotter_list;
    ...
    private boolean isPositionFooter(int position) {
        ...
        return position >=data.size()+1 && position<fotter_list.size();
    }
