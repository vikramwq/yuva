...
public class VersionUtils {
    ...
    public static boolean getIsHomeVersionChanged(Context context, Home home, String key) {
        Version version = getSavedVersion();
    ...
    public static boolean getIsLiveVersionChanged(ChannelsData channelsData) {
        Version version = getSavedVersion();
        if (version != null && channelsData != null && channelsData.getVersion() != null
                && !channelsData.getVersion().equalsIgnoreCase(version.live_version)) {
            return true;
        }
