 ...
 * Created by Nikhil on 15/12/23.
 */
public class CrackerBang extends View {
    ...
    private CrackerBangListener mListener;
    private int centerY;
    private int centerX;

   
    public CrackerBang(Context context) {
        super(context);
        init(null, 0);
    }

    public CrackerBang(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public CrackerBang(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public CrackerBang(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        init(attrs, defStyleAttr);
    }

    public static CrackerBang attach2Window(Activity activity) {
        ViewGroup rootView = (ViewGroup) activity.findViewById(Window.ID_ANDROID_CONTENT);
        CrackerBang smallBang = new CrackerBang(activity);
     ...
     * @param listener
     */
    public void setmListener(CrackerBangListener listener) {
    ...
    public void bang(final View view, CrackerBangListener listener) {
        bang(view, -1, listener);
    }

    public void bang(final View view, float radius, CrackerBangListener listener) {
