...
public abstract class EndlessParentScrollListener implements NestedScrollView.OnScrollChangeListener {
        ...
        Context context;
        public EndlessParentScrollListener(Context context,RecyclerView.LayoutManager layoutManager, RecyclerView mUpcomingRecylerview) {
            this.mLayoutManager = layoutManager;
            this.recyclerView=mUpcomingRecylerview;
        ...
        public void onScrollChange(NestedScrollView scrollView, int x, int y, int oldx, int oldy) {
            ...
            if (!loading && distanceToEnd <= visibleThresholdDistance) {
              ...
              //  GridLayoutManager _layoutManager = new GridLayoutManager(context, 2, GridLayoutManager.VERTICAL, false);
